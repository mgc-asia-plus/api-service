...
import (
	...
	amqprpc "github.com/evrone/api-servicee/internal/controller/amqp_rpc"
	"github.com/evrone/api-servicee/internal/controller/grpc"
	natsrpc "github.com/evrone/api-servicee/internal/controller/nats_rpc"
	"github.com/evrone/api-servicee/internal/controller/restapi"
	"github.com/evrone/api-servicee/internal/repo/persistent"
	"github.com/evrone/api-servicee/internal/repo/webapi"
	"github.com/evrone/api-servicee/internal/usecase/translation"
	"github.com/evrone/api-servicee/pkg/grpcserver"
	"github.com/evrone/api-servicee/pkg/httpserver"
	"github.com/evrone/api-servicee/pkg/logger"
	natsRPCServer "github.com/evrone/api-servicee/pkg/nats/nats_rpc/server"
	"github.com/evrone/api-servicee/pkg/postgres"
	rmqRPCServer "github.com/evrone/api-servicee/pkg/rabbitmq/rmq_rpc/server"
)
